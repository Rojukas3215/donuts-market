...
class MockDatabase {
  ...
  seed() {
    ...
    const sellerId = 'u-seller-2';
    const buyerId = 'u-buyer-3';

    this.users.push(
      { id: adminId, email: 'admin@donutmarket.com', password: '$2a$10$X8Ld12Wk2c88L9Y/X0X7OeK0w7zP11Lh.LdY/zB6b7M8z5l5X82Bq', role: 'ADMIN', status: 'ACTIVE', createdAt: new Date() },
      { id: sellerId, email: 'steve@donutmarket.com', password: '$2a$10$X8Ld12Wk2c88L9Y/X0X7OeK0w7zP11Lh.LdY/zB6b7M8z5l5X82Bq', role: 'USER', status: 'ACTIVE', createdAt: new Date() },
      { id: buyerId, email: 'alex@donutmarket.com', password: '$2a$10$X8Ld12Wk2c88L9Y/X0X7OeK0w7zP11Lh.LdY/zB6b7M8z5l5X82Bq', role: 'USER', status: 'ACTIVE', createdAt: new Date() }
    );

    // Seed Profiles
    this.profiles.push(
      { id: 'p-admin', userId: adminId, minecraftUsername: 'DonutAdmin', avatarUrl: 'https://mc-heads.net/avatar/DonutAdmin', completedTrades: 0, averageRating: 5.0, reviewCount: 0, verified: true, createdAt: new Date() },
      { id: 'p-seller', userId: sellerId, minecraftUsername: 'Steve', avatarUrl: 'https://mc-heads.net/avatar/Steve', completedTrades: 34, averageRating: 4.8, reviewCount: 5, verified: true, createdAt: new Date() },
      { id: 'p-buyer', userId: buyerId, minecraftUsername: 'Alex', avatarUrl: 'https://mc-heads.net/avatar/Alex', completedTrades: 12, averageRating: 4.5, reviewCount: 2, verified: false, createdAt: new Date() }
    );
    ...
    this.listings.push(
      {
        id: list1Id,
        title: 'Zombie & Skeleton Double Spawner',
        description: 'Fully set up double spawner with auto-kill chamber, sorting system, and items collection chests. Located near spawn coordinates.',
        category: 'Spawners',
        price: 45000,
        images: ['/uploads/spawner.png'],
        sellerId: sellerId,
        sellerUsername: 'Steve',
        sellerAvatar: 'https://mc-heads.net/avatar/Steve',
        status: 'ACTIVE',
        type: 'FIXED',
        viewsCount: 128,
        favoritesCount: 15,
        propertyWarning: true, // properties like spawners cannot be automatically traded
        isFeatured: true,
        createdAt: new Date(Date.now() - 3600000 * 24)
      },
      {
        id: list2Id,
        title: 'Max Prot IV Netherite Armor Set',
        description: 'Full set of Netherite Armor: Protection IV, Mending, Unbreaking III. Freshly repaired, ready for PvP or raiding!',
        category: 'Armor',
        price: 120000,
        images: ['/uploads/armor.png'],
        sellerId: sellerId,
        sellerUsername: 'Steve',
        sellerAvatar: 'https://mc-heads.net/avatar/Steve',
        status: 'ACTIVE',
      ...
      {
        id: list3Id,
        title: 'God Sword: Sharpness VI Fire Aspect II',
        description: 'Custom Sharpness VI Netherite Sword with Mending, Looting III, Knockback II, Fire Aspect II. Unbelievable damage.',
        category: 'Weapons',
        price: 15000, // starting bid
        images: ['/uploads/sword.png'],
        sellerId: sellerId,
        sellerUsername: 'Steve',
        sellerAvatar: 'https://mc-heads.net/avatar/Steve',
        status: 'ACTIVE',
      ...
      {
        id: list4Id,
        title: 'Spawn Base #4 Prime Location',
        description: 'Prime real estate spawn shop with 24 item slots. Chest shops pre-configured. Generate passive income!',
        category: 'Bases',
        price: 3500000,
        images: ['/uploads/shop.png'],
        sellerId: sellerId,
        sellerUsername: 'Steve',
        sellerAvatar: 'https://mc-heads.net/avatar/Steve',
        status: 'ACTIVE',
      ...
      {
        id: list5Id,
        title: 'PvP Combat Training (1 Hour)',
        description: 'Get coached by a top 10 leaderboard PVPer. Focuses on shield disabling, crystal PvP, pot rotation, and movement.',
        category: 'Services',
        price: 25000,
        images: ['/uploads/pvp.png'],
        sellerId: sellerId,
        sellerUsername: 'Steve',
        sellerAvatar: 'https://mc-heads.net/avatar/Steve',
        status: 'ACTIVE',
    ...
    this.auctions.push({
      ...
      endDate: new Date(Date.now() + 3600000 * 48), // ends in 48 hours
      currentBid: 18000,
      currentBidderId: buyerId,
      currentBidderUsername: 'Alex',
      winnerId: null,
      bidCount: 3,
      status: 'ACTIVE'
    });
    ...
    // Seed Bids
    this.bids.push(
      { id: 'b-1', auctionId: 'a-1', bidderId: buyerId, bidderUsername: 'Alex', amount: 16000, createdAt: new Date(Date.now() - 3600000 * 4) },
      { id: 'b-2', auctionId: 'a-1', bidderId: adminId, bidderUsername: 'DonutAdmin', amount: 17000, createdAt: new Date(Date.now() - 3600000 * 3) },
      { id: 'b-3', auctionId: 'a-1', bidderId: buyerId, bidderUsername: 'Alex', amount: 18000, createdAt: new Date(Date.now() - 3600000 * 2) }
    );

    // Seed Favorites
    this.favorites.push({ id: 'fav-1', userId: buyerId, listingId: list2Id, createdAt: new Date() });

    // Seed Reviews
    this.reviews.push(
      { id: 'rev-1', reviewerId: buyerId, reviewerUsername: 'Alex', revieweeId: sellerId, rating: 5, text: 'Fast trade and very friendly. Recomended!', tradeTicketId: 't-seeded-1', createdAt: new Date() },
      { id: 'rev-2', reviewerId: adminId, reviewerUsername: 'DonutAdmin', revieweeId: sellerId, rating: 4, text: 'Transaction went smoothly, base coordinates are legit.', tradeTicketId: 't-seeded-2', createdAt: new Date() }
    );
  }
}
